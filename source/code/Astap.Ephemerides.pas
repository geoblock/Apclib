unit Astap.Ephemerides;
(*
*  These PASCAL routines where created by Han Kleijn www.hnsky.org for the ASTAP program
*  and are based on Fortran code from https://github.com/scottransom/pyslalib.
...
begin
  ...
  sla_PREC(2000 + (JD0 - 2451545) / 365.25, 2000 + (JD1 - 2451545) / 365.25, RMATP);
  // EP1=2000D0 + (DATE-51544.5D0)/365.25D0
...
//  J2000 heliocentric or barycentric Earth position and velocity.
//  Light speed corrected. If bary is false, heliocentric, if true barycentric
procedure sla_EPV2 (DATE : double; bary :boolean; out PE, VE : r3_array);
...
*)
  ...
  more efficient.
  Furthermore in the Fortran orginal version Heliocentric and Barycentric where always both calculated.
  In the Pascal version barycentric is only calculated when specified.
  *)
